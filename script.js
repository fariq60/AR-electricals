...
const products = [
  ...
  },
  {
    ...
    name: "IT Panel",
    code: "AR-IT / PANEL",
    image: "assets/products/it-panel.png",
    description: "Industrial IT panel solution designed for reliable electrical control, protection and distribution.",
    tags: ["IT Panel", "Control", "Distribution"]
  },
  {
    id: "load-bank-2",
    name: "Load Bank",
